...
I_attention=st.slider("Please select number 1 for this question. This is an attention-check question.", 1, 7, key="I_attention")
I7=st.slider("I felt more confident in the decisions I made after viewing the images", 1, 7, key="I7")

if st.button("Confirm"):
    st.session_state['C2_questions'] = [I1, I2, I3, I4, I5, I6, I_attention, I7]
